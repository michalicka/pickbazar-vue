export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      "common:text-search-label": "grocery search at header",
      ...
      "common:text-sellers": "Sellers",
      "text-sub-orders": "Sub Orders",
      "text-new": "New",
      "common:text-new": "New",
      ...
      "heading-grocery": "Groceries Delivered in 90 Minute",
      "subheading-grocery": "Get your healthy foods & snacks delivered at your doorsteps all day everyday",
      "heading-bakery": "Get Your Bakery Items Delivered",
      "subheading-bakery": "Get your favorite bakery items baked and delivered to your doorsteps at any time",
      "heading-makeup": "Branded & imported makeups",
      "subheading-makeup": "Easiest and cheapest way to get your branded & imported makeups",
      "heading-bags": "Exclusive Branded bags",
      "subheading-bags": "Get your exclusive & branded bags delivered to you in no time",
      "heading-clothing": "Shop your designer dresses",
      "subheading-clothing": "Ready to wear dresses tailored for you from online. Hurry up while stock lasts.",
      "heading-furniture": "Exclusive furniture on cheap price",
      "subheading-furniture": "Make your house a home with our wide collection of beautiful furniture",
      "banner:promotion-slide-one": "Coupon Savings",
      "banner:promotion-slide-two": "Free Delivery",
      "banner:promotion-slide-three": "Gift Voucher",
      "banner:promotion-slide-four": "Cash On Delivery",
      "banner:promotion-slide-five": "Express Delivery",
      "button-cancel": "Cancel",
      "button-delete": "Delete",
      "delete-item-confirm": "Confirm deleting this item",
      "table:empty-table-data": "No data",
      "common:text-forgot-password": "Forgot password?",
      "faq-one-title": "How to contact with Customer Service?",
      "faq-one-content": "Our Customer Experience Team is available 7 days a week and we offer 2 ways to get in contact.Email and Chat . We try to reply quickly, so you need not to wait too long for a response!.",
      "faq-two-title": "App installation failed, how to update system information?",
      "faq-two-content": "Please read the documentation carefully . We also have some online video tutorials regarding this issue . If the problem remains, Please Open a ticket in the support forum",
      "faq-three-title": "Website response taking time, how to improve?",
      "faq-three-content": "At first, Please check your internet connection . We also have some online video tutorials regarding this issue . If the problem remains, Please Open a ticket in the support forum.",
      "faq-four-title": "How do I create a account?",
      "faq-four-content": "If you want to open an account for personal use you can do it over the phone or online. Opening an account online should only take a few minutes.",
      "email-sent-successful": "Email sent successfully",
      "see-more": "See more"
    }
  }
}))
